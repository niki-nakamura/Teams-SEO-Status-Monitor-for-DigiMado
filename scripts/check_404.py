...
# Microsoft TeamsのWebhook URL（GitHub Secretsにて登録し、envで読み込む）
TEAMS_WEBHOOK_URL = os.environ.get("TEAMS_WEBHOOK_URL")

# メインサイトマップ（対象サイトを https://digi-mado.jp/ に変更）
...
def send_teams_notification(message):
    """
    Microsoft TeamsのWebhookに対してメッセージをPOSTする。
    TeamsではMessageCard形式を使用する。
    """
